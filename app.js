/* CQE Exam Simulator, Application Logic */

const ACCESS_CODE  = "CQE9000";
const EXAM_SECONDS = 19080;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "cqe_exam_state_v1";
const SIM_Q_COUNT  = 160;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const CLUSTER_LABEL = "Case";
const DOMAIN_LABELS = {"management_and_leadership": "Management and Leadership", "the_quality_system": "The Quality System", "product_process_and_service_design": "Product Process and Service Design", "product_and_process_control": "Product and Process Control", "continuous_improvement": "Continuous Improvement", "quantitative_methods_and_tools": "Quantitative Methods and Tools", "risk_management": "Risk Management"};  // maps domain key -> human-readable label for display
